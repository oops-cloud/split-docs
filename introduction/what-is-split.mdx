...
Split is a token launchpad on Solana where **every trade pays every holder**. 1.3% of every trade is distributed directly to token holders — weighted by balance and hold duration.
